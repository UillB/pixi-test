...
export class UiManager extends PIXI.utils.EventEmitter {
	...
	init(resources: PIXI.IResourceDictionary, params?: IUiOptions) {
		...
		this._controls.position.y = this.app.height - GlobalConfig.Settings.ControlsBottomOffset;
		...
		this._controls_full.position.y = this.app.height - GlobalConfig.Settings.ControlsBottomOffset;
